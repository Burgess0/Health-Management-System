<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Zixunxinxi_updt.aspx.cs" Inherits="Zixunxinxi_updt" %>
...
<form action="Zixunxinxi_updt.aspx?f=f" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                            ...
                            <input type="text" class="form-control" placeholder="输入标题" style="width:250px;" data-rule-required="true" data-msg-required="请填写标题" remote="action.ashx?a=checkno&checktype=update&id=<%= mmm["id"] %>&table=zixunxinxi&col=biaoti" data-msg-remote="内容重复了" id="biaoti" name="biaoti" value="<%= Info.html(mmm["biaoti"]) %>"/>                    
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                            ...
                            <select class="form-control class_fenlei8" data-value="<%= Info.html(mmm["fenlei"]) %>" data-rule-required="true" data-msg-required="请填写分类" id="fenlei" name="fenlei" style="width:250px">
