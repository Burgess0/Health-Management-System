...
!(function (a, b) {
                    ...
                    preFilter: {
                        ...
                        PSEUDO: function (a) {
                            ...
                            return V.CHILD.test(a[0])
                                ...
                                : (a[3] && void 0 !== a[4]
                                      ? (a[2] = a[4])
                                      : c && T.test(c) && (b = ob(c, !0)) && (b = c.indexOf(")", c.length - b) - c.length) && ((a[0] = a[0].slice(0, b)), (a[2] = c.slice(0, b))),
                                  a.slice(0, 3));
                        },
                    },
                    filter: {
        ...
        n(function () {
            ...
            c &&
                ...
                typeof b.style.zoom !== L &&
                    ((b.style.cssText = "border:0;margin:0;width:1px;padding:1px;display:inline;zoom:1"), (l.inlineBlockNeedsLayout = 3 === b.offsetWidth) && (c.style.zoom = 1)),
                c.removeChild(a),
                (a = b = null));
        }),
        (function () {
    ...
    (n.event = {
        ...
        fix: function (a) {
            ...
            return (
                a.target || (a.target = f.srcElement || z), 3 === a.target.nodeType && (a.target = a.target.parentNode), (a.metaKey = !!a.metaKey), g.filter ? g.filter(a, f) : a
            );
        },
                ...
                ? (a && a.type
                      ? ((this.originalEvent = a),
                        ...
                        (this.isDefaultPrevented =
                            a.defaultPrevented || (void 0 === a.defaultPrevented && (a.returnValue === !1 || (a.getPreventDefault && a.getPreventDefault()))) ? bb : cb))
                      : (this.type = a),
                  b && n.extend(this, b),
                        ...
                        for (h = g[g.length - 1].ownerDocument, n.map(g, zb), j = 0; f > j; j++)
                            (d = g[j]),
                                pb.test(d.type || "") &&
                                    ...
                                    n.contains(h, d) &&
                                    (d.src ? n._evalUrl && n._evalUrl(d.src) : n.globalEval((d.text || d.textContent || d.innerHTML || "").replace(rb, "")));
                    i = c = null;
                }
                return this;
            },
                ...
                if (null == b) {
                    ...
                    (f = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px"),
                        ...
                        typeof e.style.zoom !== L &&
                            ((e.style.cssText = d + ";width:1px;padding:1px;zoom:1"), (e.innerHTML = "<div></div>"), (e.firstChild.style.width = "5px"), (b = 3 !== e.offsetWidth)),
                        a.removeChild(c),
                        (a = c = e = null);
                }
                return b;
        ...
        l.opacity ||
            (n.cssHooks.opacity = {
                ...
                set: function (a, b) {
                    ...
                    (c.zoom = 1),
                        ((b >= 1 || "" === b) && "" === n.trim(f.replace(Nb, "")) && c.removeAttribute && (c.removeAttribute("filter"), "" === b || (d && !d.filter))) ||
    ...
    (n.Animation = n.extend(lc, {
        ...
        n.each(
            { slideDown: hc("show"), slideUp: hc("hide"), slideToggle: hc("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } },
            function (a, b) {
    ...
    n.extend({
        ...
        ajax: function (a, b) {
            ...
            (h = k.global),
                ...
                v.setRequestHeader(
                    "Accept",
                    k.dataTypes[0] && k.accepts[k.dataTypes[0]] ? k.accepts[k.dataTypes[0]] + ("*" !== k.dataTypes[0] ? ", " + Kc + "; q=0.01" : "") : k.accepts["*"]
                );
    ...
    n.ajaxSetup({
        ...
        n.ajaxPrefilter("json jsonp", function (b, c, d) {
            var e,
                ...
                h =
                    b.jsonp !== !1 &&
                    (bd.test(b.url) ? "url" : "string" == typeof b.data && !(b.contentType || "").indexOf("application/x-www-form-urlencoded") && bd.test(b.data) && "data");
