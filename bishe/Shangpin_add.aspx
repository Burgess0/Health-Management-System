<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shangpin_add.aspx.cs" Inherits="Shangpin_add" %>
...
<form action="Shangpin_add.aspx?f=f" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                            ...
                            <input type="text" class="form-control" placeholder="输入名称" style="width:250px;" data-rule-required="true" data-msg-required="请填写名称" id="mingcheng" name="mingcheng" value=""/>                    
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                            ...
                            <select class="form-control class_fenlei10" data-value="" id="fenlei" name="fenlei" style="width:250px">
...
<% } %>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                            ...
                            <div class="class_shifouxinpin11" data-value=""> <label><input type="radio" id="shifouxinpin" name="shifouxinpin" value="是"/> 是</label> 
