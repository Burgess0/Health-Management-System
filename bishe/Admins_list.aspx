<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admins_list.aspx.cs" Inherits="Admins_list" %>
...
<div class="form-search pa10 bg-warning">
    <form class="form-inline" action="?" size="small" id="formSearch"><!-- form 标签开始 -->
                   ...
                   帐号： <input type="text" class="form-control" style="" name="username" value="<%= Request["username"] %>"/>
                    ...
                    <td width="30" align="center">
                        <label>
                            ...
                            <%= map["pwd"] %>                        </td>
                                                            ...
                                                            <td align="center">
                                                                        <a class="btn btn-success btn-xs" href="Admins_updt.aspx?id=<%= map["id"] %>" title="编辑"> 编辑 </a>  
