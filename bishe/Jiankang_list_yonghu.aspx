<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Jiankang_list_yonghu.aspx.cs" Inherits="Jiankang_list_yonghu" %>
...
<div class="form-search pa10 bg-warning">
    <form class="form-inline" action="?" size="small" id="formSearch"><!-- form 标签开始 -->
                   ...
                   运动类型： <select class="form-control class_yundongleixing17" data-value="<%= Request["yundongleixing"] %>" id="yundongleixing" name="yundongleixing">
...
<script>
$(".class_yundongleixing17").val($(".class_yundongleixing17").attr("data-value"))</script>
                ...
                <tr id="<%= map["id"] %>" pid="">
                    <td width="30" align="center">
                        <label>
                            ...
                            <%= map["bmi"] %>                        </td>
                                            <td>
                            <%  var mapleixing27 = Dao.find("SELECT leixingming,id FROM leixing where id='"+map["yundongleixing"]+"'");  %><%= mapleixing27["leixingming"] %>                        </td>
                                            <td>
