<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Dingdan_list.aspx.cs" Inherits="Dingdan_list" %>
...
<%  if(map["zhuangtai"].Equals("待发货")  ){  %>
<a class="btn btn-primary btn-xs" href="Fahuo_add.aspx?id=<%= map["id"] %>"> 发货 </a>  
