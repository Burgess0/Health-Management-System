<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Gouwuche_add.aspx.cs" Inherits="Gouwuche_add" %>
...
<form action="Gouwuche_add.aspx?f=f" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                            ...
                            <%  var mapfenlei15 = Dao.find("SELECT fenleiming,id FROM fenlei where id='"+readMap["fenlei"]+"'");  %><%= mapfenlei15["fenleiming"] %><input type="hidden" id="fenlei" name="fenlei" value="<%= Info.html(readMap["fenlei"]) %>"/>                    
        </div>
