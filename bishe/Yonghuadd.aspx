<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Yonghuadd.aspx.cs" Inherits="Yonghuadd" %>
...
<form action="Yonghu_add.aspx?f=f" method="post" name="form1" id="form1"><!-- form 标签开始 -->
