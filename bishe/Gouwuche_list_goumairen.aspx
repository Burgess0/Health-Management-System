<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Gouwuche_list_goumairen.aspx.cs" Inherits="Gouwuche_list_goumairen" %>
...
<div class="form-search pa10 bg-warning">
    <form class="form-inline" action="?" size="small" id="formSearch"><!-- form 标签开始 -->
                   ...
                   分类： <select class="form-control class_fenlei15" data-value="<%= Request["fenlei"] %>" id="fenlei" name="fenlei">
                ...
                <tr id="<%= map["id"] %>" pid="">
                    <td width="30" align="center">
                        <label>
                            ...
                            <%= map["mingcheng"] %>                        </td>
                                            <td>
                            <%  var mapfenlei14 = Dao.find("SELECT fenleiming,id FROM fenlei where id='"+map["fenlei"]+"'");  %><%= mapfenlei14["fenleiming"] %>                        </td>
                                            <td>
                            <%= map["jiage"] %>                        </td>
                                            <td>
                            <%= map["goumaishu"] %>                        </td>
