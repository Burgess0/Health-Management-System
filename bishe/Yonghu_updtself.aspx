<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Yonghu_updtself.aspx.cs" Inherits="Yonghu_updtself" %>
...
<form action="Yonghu_updt.aspx?f=f" method="post" name="form1" id="form1"><!-- form 标签开始 -->
