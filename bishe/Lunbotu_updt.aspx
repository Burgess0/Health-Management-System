<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Lunbotu_updt.aspx.cs" Inherits="Lunbotu_updt" %>
...
<form action="Lunbotu_updt.aspx?f=f" method="post" name="form1" id="form1"><!-- form 标签开始 -->
