<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Yonghu_add.aspx.cs" Inherits="Yonghu_add" %>
...
<div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form action="Yonghu_add.aspx?f=f" method="post" name="form1" id="form1">
                <!-- form 标签开始 -->
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="text" class="form-control" placeholder="输入用户名" style="width:150px;" data-rule-required="true" data-msg-required="请填写用户名" remote="action.ashx?a=checkno&checktype=insert&table=yonghu&col=yonghuming" data-msg-remote="内容重复了" id="yonghuming" name="yonghuming" value=""/>
                        </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="text" class="form-control" placeholder="输入身份证" style="width:250px;" idcard="true" data-msg-email="请输入有效身份证号码" id="shenfenzheng" name="shenfenzheng" value=""/>
                        </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <label style="text-align: right" class="col-sm-2 hiddex-xs"> </label>
                             <input name="referer" value="./login.aspx" type="hidden"/>
                        <div class="col-sm-10">
