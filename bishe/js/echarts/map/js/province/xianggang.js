    ...
    echarts.registerMap("香港", {
        ...
        features: [
            ...
            },
            {
                id: "810006",
                type: "Feature",
                geometry: { type: "Polygon", coordinates: ["@@H[@EEGU@KCCDGEEABQi@AHCF@B^P@BABOFCFBFF@FDNADADHJDjB"], encodeOffsets: [[116919, 22881]] },
                properties: { cp: [114.163349, 22.333775], name: "深水埗区", childNum: 1 },
            },
            {
                id: "810007",
                type: "Feature",
                geometry: { type: "Polygon", coordinates: ["@@DEBEFC@CJKD@DCHDLDBMEG@CFCLICETSDQSJeMGVKHGJIR@HFJBFG^FDF@"], encodeOffsets: [[116925, 22883]] },
                properties: { cp: [114.193047, 22.312373], name: "九龙城区", childNum: 1 },
            },
            {
                id: "810008",
                type: "Feature",
                geometry: { type: "Polygon", coordinates: ["@@AC@IH_BAYCEDIAGDICGCCDC@IL@DEDAFCFNDVD@BADBBHCFDJA^D"], encodeOffsets: [[116970, 22892]] },
                properties: { cp: [114.203985, 22.336112], name: "黄大仙区", childNum: 1 },
            },
            {
                id: "810009",
                type: "Feature",
                geometry: { type: "Polygon", coordinates: ["@@F@HWF@DABD@IHBB@GOAENMBE@AEAGOBCFE@CqXCRSTDFKJED@DFHANFCJBFCZD"], encodeOffsets: [[116974, 22868]] },
