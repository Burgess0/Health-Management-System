<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Fahuo_list_xiadanren.aspx.cs" Inherits="Fahuo_list_xiadanren" %>
                    ...
                    <td width="30" align="center">
                        <label>
                            ...
                            <%= map["fahuoren"] %>                        </td>
                                                            ...
                                                            <td align="center">
                                                                        <a class="btn btn-success btn-xs" href="Fahuo_updt.aspx?id=<%= map["id"] %>" title="编辑"> 编辑 </a>  
