...
<div class="form-search pa10 bg-warning">
    <form class="form-inline" action="?" size="small" id="formSearch"><!-- form 标签开始 -->
                   ...
                   类型名： <input type="text" class="form-control" style="" name="leixingming" value="<%= Request["leixingming"] %>"/>
                    ...
                    <td width="30" align="center">
                        <label>
                            ...
                            <%= map["leixingming"] %>                        </td>
                                                            ...
                                                            <td align="center">
                                                                        <a class="btn btn-success btn-xs" href="Leixing_updt.aspx?id=<%= map["id"] %>" title="编辑"> 编辑 </a>  
