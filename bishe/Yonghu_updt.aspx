<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Yonghu_updt.aspx.cs" Inherits="Yonghu_updt" %>
...
<div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form action="Yonghu_updt.aspx?f=f" method="post" name="form1" id="form1">
                <!-- form 标签开始 -->
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="text" class="form-control" placeholder="输入用户名" style="width:150px;" data-rule-required="true" data-msg-required="请填写用户名" remote="action.ashx?a=checkno&checktype=update&id=<%= mmm["id"] %>&table=yonghu&col=yonghuming" data-msg-remote="内容重复了" id="yonghuming" name="yonghuming" value="<%= Info.html(mmm["yonghuming"]) %>"/>
                        </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="text" class="form-control" placeholder="输入身份证" style="width:250px;" idcard="true" data-msg-email="请输入有效身份证号码" id="shenfenzheng" name="shenfenzheng" value="<%= Info.html(mmm["shenfenzheng"]) %>"/>
                        </div>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="input-group" style="width:250px">
                                ...
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-default" onclick="layer.open({type:2,title:'上传图片',fixed:true,shadeClose:true,shade:0.5,area:['320px','150px'],content:'upload.html?result=touxiang'})">
                                        上传图片
                                    </button>
                                </span>
                            </div>
